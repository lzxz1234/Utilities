...
var tools = ["记事本写程序", "Windows8", "Linux", "MacOS", "QQ浏览器", "三星手机", "iphone5"];

var food = ["麦当劳", "肯德基", "老盛昌", "盒饭", "四海游龙", "自己带的饭", "永和大王", "生煎锅贴", "批萨","甜点","肉包子","火锅",'蛋包饭',"牛排","鸡公煲","村夫烤鱼","麻辣烫","桂林米粉"];
...
var dosth = ["跳肚皮舞","看美女","搓麻将","炸金花","玩DOTA","写代码","洗桑拿","听神曲忐忑","打实况足球","嗑瓜子"];
...
$(function(){
	$('.date').html(getTodayString() + "<a href=\"#\" style=\"float: right;\" onclick='javascript: $(\".rightcorner\").remove();' >X</a>");
